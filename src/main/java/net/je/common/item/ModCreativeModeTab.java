...
public class ModCreativeModeTab {
	...
	public static final RegistryObject<CreativeModeTab> BLOCKS_TAB = CREATIVE_MODE_TABS.register("je_blocks_tab",
			...
			.displayItems((pParameters, pOutput) -> {
				...
				pOutput.accept(ModBlocks.POLISHED_SHADOW_STONE.get());
				pOutput.accept(ModBlocks.POLISHED_SHADOW_STONE_STAIRS.get());
	...
	public static final RegistryObject<CreativeModeTab> ITEMS_TAB = CREATIVE_MODE_TABS.register("je_items_tab",
			...
			.displayItems((pParameters, pOutput) -> {
				...
				pOutput.accept(ModItems.SHADOW_LORD_SPAWN_EGG.get());
