...
public class EndStoneFurnaceScreen extends AbstractContainerScreen<EndStoneFurnaceMenu> {
	...
	protected void renderBg(GuiGraphics pGuiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
		...
		if (this.menu.isLit()) {
			...
			pGuiGraphics.blit(LIT_PROGRESS_SPRITE, 14, 14, 0, 14 - l, i + 56, j + 36 + 14 - l, 14, l);
		}

		int j1 = Mth.ceil(this.menu.getBurnProgress() * 24.0F);
		pGuiGraphics.blit(BURN_PROGRESS_SPRITE, 24, 16, 0, 0, i + 79, j + 34, j1, 16);
	}
