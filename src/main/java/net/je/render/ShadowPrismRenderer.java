...
public class ShadowPrismRenderer implements BlockEntityRenderer<ShadowPrismBlockEntity> {
    ...
    public void render(ShadowPrismBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
    	ShaderInstance shader = Minecraft.getInstance().gameRenderer.getShader("rendertype_shadow_prism");
    ...
    private void renderFace(
    		ShadowPrismBlockEntity pBlockEntity,
        Matrix4f pPose,
